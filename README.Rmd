...
- Implement a simple Approximate Bayesian Computation algorithm to see what plausible combinations of parameter values may approximate to the observed marginal distributions,
