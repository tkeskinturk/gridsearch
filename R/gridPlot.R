...
#' Plot DGP Grids
#'
#' This function plots the distribution of accepted samples resulting from `gridSearch`.
#' @param data A data frame generated by `gridSearch`.
#' @param type If `posterior`, plots a density plot for each non-fixed parameter. If `conditional`, plots the accepted samples by different balance levels.
#'
